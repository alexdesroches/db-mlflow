...
# import to enable removal on non-alphanumeric characters
import re
...
local_data_path = f"mlflowdemo-{clean_team_name}/"
...
dbfs_data_path = f"mlflowdemo-{clean_team_name}/"
...
# Create local directories used in the demo
